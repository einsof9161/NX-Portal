...
<!-- 
載入了相關的Js依賴,
1.jQuery 2.1.4:dom操作
2.Bootstrap 3.3.5:RWD佈局
3.iCheck:checkbox美化
4.SlimScroll:捲動
 -->
<%@ include file="/WEB-INF/tags/common.jsp" %>
  ...
  <body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>N測試</b>X</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>NX</b>試FlowSystem</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li>start message
                        <a href="#">
                          <div class="pull-left">
                            <img src="${serverResourcesCtx}/plugins/adminLTE/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <!-- <img src="${serverResourcesCtx}/plugins/adminLTE/img/user2-160x160.jpg" class="user-image" alt="User Image">
                  -->  <span class="hidden-xs">Welcome : 張宸邦</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
    ...
    <script src="${serverResourcesCtx}/plugins/adminLTE/js/demo.js"></script> -->
  </body>
</html>
